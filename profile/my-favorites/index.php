<?php
    ...
    foreach ($games as $game) {
        if (in_array($game['id'], $myFavoritesId)) {
            $myFavoriteGames[$game['id']] = $game;
        }
    }
...
<head>
    ...
    <title>Favoritos | Game Shop</title>
</head>
<body>
    <header>
